...
from experiments.LinearProb import Linear_Prob
...
# --------------------------------------------------- I/O --------------------------------------------------------------
parser.add_argument('--data_dir', default='datasets/ICA_TUEV', help='Data directory')
...
parser.add_argument('--Training_mode', default='Supervise_training', choices={'Supervise_training', 'Pretraining_Finetuning', 'Zero-Shot'}, 
                    help="Training Mode")
...
if __name__ == '__main__':
    ...
    elif config['Training_mode'] == 'Linear_Prob':
        best_aggr_metrics_test = Linear_Prob(Data)
