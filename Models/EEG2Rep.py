...
from Models.position_embedding import PositionalEmbedding1D
...
class EEG2Rep(nn.Module):
    def __init__(self, config):
        ...
        self.PositionalEncoding = PositionalEmbedding1D(seq_len, emb_size)
        # -------------------------------------------------------------------------
    ...
    def pretrain_forward(self, x):
        ...
        return [target_rep_mask, target_prediction]
